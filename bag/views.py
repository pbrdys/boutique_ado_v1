...
def remove_from_bag(request, item_id):
    ...
    try:
        ...
        if size:
            ...
            if not bag[item_id]['items_by_size']:
                bag.pop(item_id)
            messages.success(request, mark_safe(f'Removed size {size.upper()} <b>{product.name}</b> from your bag'))
        else:
            bag.pop(item_id)
            messages.success(request, mark_safe(f'Removed <b>{product.name}</b> from your bag'))
